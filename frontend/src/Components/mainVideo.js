  ...
  render() {
    return (
      <section className="video">
        <video
          src={
            this.props.video + "?api_key=c1a04dd4-7ee0-41b1-9822-b92dcec3b769"
          }
          controls
        ></video>
        ...
        <div className="video__publisher">
          ...
          <button className="video__subscribe">
            <span>SUBSCRIBE</span>
            <span className="video__subscribe--view">
